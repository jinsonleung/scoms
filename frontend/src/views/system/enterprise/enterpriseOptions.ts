...
// 企业类型选项对象数组
export const enterpriseTypeOptions: Array<SelectOptionTypes> = [
    {
        value: '1',
        label: '外商投资企业',
    },
...
// 企业体系结构选项对象数组
export const enterpriseArchitectureOptions: Array<SelectOptionTypes> = [
    {
        value: '1',
        label: '总公司',
    },
...
// 所在行业选项对象数组
export const industryOptions: Array<SelectOptionTypes> = [
    {
        value: '1',
        label: '物流运输',
    },
