      ...
      <el-dialog title="修改供应商信息" v-model="isShowDialog" width="800px">
        <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" size="small" label-width="110px">
          <el-row :gutter="10">
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
              <el-form-item label="照业执照图片" prop="business_licence_image">
                <el-input v-model="ruleForm.business_licence_image" placeholder="请照业执照图片" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
              <el-form-item label="银行对公账户" prop="banking_account_info">
...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      ...
      ruleForm: {
        // id: '', // id
        superior_level: '', // 上级供应商
        account: '', // 供应商账号
        full_name: '', // 供应商名全称
        abbreviation_name: '', // 供应商名简称
        enterprise_type: '', // 供应商类型（外商投资供应商/股份制供应商/私营供应商/其他）
        ...
        industry: '', // 所在行业
        website: '', // 供应商网站
        legal_person_name: '', // 供应商法人姓名
        legal_person_email: '', // 供应商法人邮箱
        contact_name: '', // 联系人姓名
        contact_tel: '', // 联系人电话
        contact_phone: '', // 联系人手机
        contact_email: '', // 联系人邮箱
      ...
      enterpriseData: [] as Array<any>, // 供应商数据
      // 省市区三级联动
      // threeLevelLinkage: '',
      ...
      rules: {
        ...
        // full_name: {required: true, message: '请输入供应商名全称', trigger: 'blur'},
        // abbreviationName: {required: true, message: '请输入供应商名简称', trigger: 'blur'},
        // enterpriseType: {required: true, message: '请选择供应商类型', trigger: 'blur'},
