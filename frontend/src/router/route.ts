 ...
 *      roles：         当前路由权限标识，取角色管理。控制路由显示、隐藏。超级管理员：admin 普通角色：public
...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		...
		children: [
			...
			// 			path: '/params/public',
			// 			name: 'paramsCommon',
			// 			component: () => import('/@/views/params/public/index.vue'),
			// 			meta: {
			...
			// 			component: () => import('/@/views/params/public/details.vue'),
			// 			meta: {
			...
			// {
			// 	path: '/iframes2',
			// 	name: 'layoutIfame1View2',
			// 	component: () => import('/@/layout/routerView/iframes.vue'),
			// 	meta: {
			// 		title: 'message.router.layoutIfameView2',	// title对应i81n的router的key字段
			// 		isLink: 'https://wdd.js.org/jsplumb-chinese-tutorial/#/',
			// 		isHide: false,
			// 		isKeepAlive: false,
			// 		isAffix: true,
