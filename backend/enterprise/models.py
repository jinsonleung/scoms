...
class Enterprise(models.Model):
    ...
    enterprise_level = models.CharField(max_length=16, unique=True, verbose_name='上级企业')
    ...
    established_date = models.DateTimeField(verbose_name='成立日期')
    effective_start_date = models.DateTimeField(verbose_name='营业期限(起)')
    effective_end_date = models.DateTimeField(verbose_name='营业期限(止)')
    ...
    description = models.TextField(max_length=128, null=True, verbose_name='企业描述')
