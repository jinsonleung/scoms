    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iso3_code', models.CharField(blank=True, max_length=16, null=True, verbose_name='国家三字码')),
                ...
                ('phone_code', models.CharField(blank=True, max_length=64, null=True, verbose_name='电话区号')),
                ...
                ('description', models.TextField(blank=True, max_length=256, null=True, verbose_name='描述')),
                ('continent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='universalCode.continent', verbose_name='所在洲id(外键)')),
                ('is_delete', models.BooleanField(default=False, verbose_name='软删除标志')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='创建记录日期')),
                ('create_by', models.CharField(max_length=32, verbose_name='创建人')),
                ('update_datetime', models.DateTimeField(auto_now=True, db_index=True, verbose_name='更新记录日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('iso2_code', models.CharField(max_length=16, verbose_name='省两字码(可重复)')),
                ...
                ('wiki_data_id', models.CharField(blank=True, max_length=64, null=True, verbose_name='维基数据代码')),
                ('description', models.TextField(blank=True, max_length=256, null=True, verbose_name='描述')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='universalCode.country', verbose_name='所在国家id(外键)')),
                ('is_delete', models.BooleanField(default=False, verbose_name='软删除标志')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='创建记录日期')),
                ('create_by', models.CharField(max_length=32, verbose_name='创建人')),
                ('update_datetime', models.DateTimeField(auto_now=True, db_index=True, verbose_name='更新记录日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('iso3_code', models.CharField(blank=True, max_length=16, null=True, verbose_name='城市三字码(先设置为空，以后再补)')),
                ...
                ('wiki_data_id', models.CharField(blank=True, max_length=64, null=True, verbose_name='维基数据代码')),
                ('description', models.TextField(blank=True, max_length=256, null=True, verbose_name='描述')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='universalCode.country', verbose_name='所在国家id')),
                ('state', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='universalCode.state', verbose_name='所在省份id')),
                ('is_delete', models.BooleanField(default=False, verbose_name='软删除标志')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='创建记录日期')),
                ('create_by', models.CharField(max_length=32, verbose_name='创建人')),
                ('update_datetime', models.DateTimeField(auto_now=True, db_index=True, verbose_name='更新记录日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=256, null=True, verbose_name='描述')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='universalCode.city', verbose_name='所在城市id')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='universalCode.country', verbose_name='所在国家')),
                ('is_delete', models.BooleanField(default=False, verbose_name='软删除标志')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='创建记录日期')),
                ('create_by', models.CharField(max_length=32, verbose_name='创建人')),
                ('update_datetime', models.DateTimeField(auto_now=True, db_index=True, verbose_name='更新记录日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_iso3_code', models.CharField(blank=True, max_length=16, null=True, verbose_name='城市三字码')),
                ('description', models.TextField(blank=True, max_length=256, null=True, verbose_name='描述')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='universalCode.city', verbose_name='所在城市id(外键)')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='universalCode.country', verbose_name='所在国家id(外键)')),
                ('is_delete', models.BooleanField(default=False, verbose_name='软删除标志')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='创建记录日期')),
                ('create_by', models.CharField(max_length=32, verbose_name='创建人')),
