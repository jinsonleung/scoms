...
class Country(BaseModel):
    ...
    capital_eng_name = models.CharField(max_length=64, blank=True, null=True, verbose_name='首都英文名称')
    capital_chn_name = models.CharField(max_length=64, blank=True, null=True, verbose_name='首都中文名称')
