...
class Department(models.Model):
    dept_id = models.CharField(max_length=16, unique=True, verbose_name='公司账号')
    dept_name = models.CharField(max_length=128, blank=False, null=False, verbose_name='公司名称')
    established = models.CharField(max_length=64, null=True, verbose_name='公司简称')
