...
def update(request):
    # res0 = request.body
    # print('==res0==', type(res0), res0) // bytes
    # res0_sl = EnterpriseSerializer(data=res0)
    # print('==res0_sl==', res0_sl)
    res1 = json.loads(request.body)
    res1_data = res1['data']    # dict
    # res1_sl = EnterpriseSerializer(data=res1)
    # print('==res1==', type(res1), res1)
    # print('==res1_data==', type(res1_data), res1_data)
    # print('==res1_sl==', res1_sl)

    res1_sl = EnterpriseSerializer(data=res1_data)
    # data1 = res1['data']
    print('==res1_sl==', type(res1_sl), res1_sl)

    response = {'result_message': 'failure', 'result_body': 'account is not existed', 'result_code': 40001}
    print('==res1_sl.is_valid==', res1_sl.is_valid())
    if res1_sl.is_valid():
        res1_sl.save()
        response = {'result_message': '222', 'result_body': 'update is successful', 'result_code': 200}
        # return JsonResponse(response)
    return JsonResponse(response)
